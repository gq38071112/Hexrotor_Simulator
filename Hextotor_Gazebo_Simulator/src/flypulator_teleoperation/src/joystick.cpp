...
torque3_(6)
{
  ...
  wrench_pub_ = nh_.advertise<geometry_msgs::Wrench>("/drone/vel_cmd", 1);
...
void TeleopDrone::joyCallback(const sensor_msgs::Joy::ConstPtr& joy)
{
 ...
 geometry_msgs::Wrench msg;
  msg.force.x = f_scale_*joy->axes[force1_];
  msg.force.y = f_scale_*joy->axes[force2_];
  msg.force.z = f_scale_*joy->axes[force3_];
  msg.torque.x = t_scale_*joy->axes[torque1_];

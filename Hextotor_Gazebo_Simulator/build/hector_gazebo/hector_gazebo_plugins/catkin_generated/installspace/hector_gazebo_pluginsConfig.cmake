...
if("FALSE" STREQUAL "TRUE")
  set(hector_gazebo_plugins_SOURCE_PREFIX /home/avalon/catkin_ws/src/hector_gazebo/hector_gazebo_plugins)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avalon/catkin_ws/install/${idir}'.  ${_report}")
    endif()
